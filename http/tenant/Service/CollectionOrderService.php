...
use app\service\CollectionOrderService as BasicCollectionOrderService;
use Workerman\Coroutine\Parallel;

class CollectionOrderService extends BasicCollectionOrderService
{
    // 分析统计最近一周的订单
    #[Cacheable(
        prefix: 'statistics:collection:order:number:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
    ...
    #[Cacheable(
        prefix: 'statistics:collection:order:successful:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
    ...
    #[Cacheable(
        prefix: 'statistics:collection:order:amount:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
    ...
    #[Cacheable(
        prefix: 'statistics:collection-success-order:hour-today:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
    ...
    #[Cacheable(
        prefix: 'statistics:collection-success-order:hour-yesterday:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
    ...
    #[Cacheable(
        prefix: 'statistics:collection-success-order:hour-week:tenantId',
        value: '_#{tenantId}}',
        ttl: 60,
        group: 'redis'
    )]
